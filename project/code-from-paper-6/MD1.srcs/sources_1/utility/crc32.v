...
//CRC claculation. Taken over without change from the ALINX ETH-example
//see also https://crctool.easics.be, which generates verilog code for other CRC's polynomials and byte width.
//polynomial: x32 + x26 + x23 + x22 + x16 + x12 + x11 + x10 + x8 + x7 + x5 + x4 + x2 + x1 + 1, which is the standard 
//of ethernet (called CRC32 Ethernet/AAL5) 

module crc32 (Clk, Reset, Data_in, Enable, Crc);
