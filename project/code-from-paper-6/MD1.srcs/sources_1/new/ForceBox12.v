...
output       [DataByteWidth_n*8-1:0]  dataBox_pp,
output       [DataByteWidth_n*8-1:0]  dataBox_pn,
output       [DataByteWidth_n*8-1:0]  dataBox_np,
output       [DataByteWidth_n*8-1:0]  dataBox_nn
);
...
wire [DataByteWidth_n*8-1:0] data_nnReshuffle = {data_nn[DataByteWidth_n*8-1:72],data_nn[24*q2 +:24],(data_nn[24*q1 +:24]-24'h400000),(data_nn[24*q0 +:24]-24'h400000)};
NeighborBox
#(  
...
wire [DataByteWidth_n*8-1:0] data_npReshuffle = {data_np[DataByteWidth_n*8-1:72],data_np[24*q2 +:24],(data_np[24*q1 +:24]-24'h400000),(data_np[24*q0 +:24]+24'h400000)};
NeighborBox
#(  
.DataByteWidth_n (DataByteWidth_n)
) NeighborBox_np 
...
wire [DataByteWidth_n*8-1:0] data_pnReshuffle = {data_pn[DataByteWidth_n*8-1:72],data_pn[24*q2 +:24],(data_pn[24*q1 +:24]+24'h400000),(data_pn[24*q0 +:24]-24'h400000)};
NeighborBox
#(  
.DataByteWidth_n (DataByteWidth_n)
) NeighborBox_pn  
...
wire [DataByteWidth_n*8-1:0] data_ppReshuffle = {data_pp[DataByteWidth_n*8-1:72],data_pp[24*q2 +:24],(data_pp[24*q1 +:24]+24'h400000),(data_pp[24*q0 +:24]+24'h400000)};
