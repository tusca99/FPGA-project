...
//controlling gtp interfaces. Copied from the ALINX project (gtp_5g_test), which is a slightly edited version of what is obtained from 
//Vivado directly as example program (gtp_ex)  
...
assign gt0_txfsmresetdone = gt0_txfsmresetdone_r2;
...
always @(posedge gt1_txusrclk2_i or negedge gt1_txfsmresetdone_i)
    begin
        ...
        begin
            gt1_txfsmresetdone_r    <=    1'b0;
            gt1_txfsmresetdone_r2   <=    1'b0;
        end
        else
        begin
            gt1_txfsmresetdone_r    <=    gt1_txfsmresetdone_i;
            gt1_txfsmresetdone_r2   <=    gt1_txfsmresetdone_r;
        end
    end
...
always @(posedge gt2_txusrclk2_i or negedge gt2_txfsmresetdone_i)
    begin
        ...
        begin
            gt2_txfsmresetdone_r    <=    1'b0;
            gt2_txfsmresetdone_r2   <=    1'b0;
        end
        else
        begin
            gt2_txfsmresetdone_r    <=    gt2_txfsmresetdone_i;
            gt2_txfsmresetdone_r2   <=    gt2_txfsmresetdone_r;
        end
    end
...
always @(posedge gt3_txusrclk2_i or negedge gt3_txfsmresetdone_i)
    begin
        ...
        begin
            gt3_txfsmresetdone_r    <=    1'b0;
            gt3_txfsmresetdone_r2   <=    1'b0;
        end
        else
        begin
            gt3_txfsmresetdone_r    <=    gt3_txfsmresetdone_i;
            gt3_txfsmresetdone_r2   <=    gt3_txfsmresetdone_r;
        end
    end
//-------------------------------------------------------------------------------------
